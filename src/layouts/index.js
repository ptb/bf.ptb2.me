...
export default (_) => pug `
  Fragment
    ...
    p Lipsum incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation 
    div#body(class=css ({ "background-color": "rgba(204,255,204,.8)", "position": "relative" }))
      div(class=css ({ "background-color": "rgba(255,255,204,.8)", "position": "absolute", "transform": "translate3d(20%,0,0)" })) Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
`
    //   div hi
