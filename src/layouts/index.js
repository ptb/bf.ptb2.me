...
export default (_) => pug `
  div(class=css ({ "background-color": "#eee", "display": "flex", "flex-direction": "column", "min-height": "100vh" }))
    ...
    div(class=css ({ "background-color": "rgba(204,255,204,.8)", "flex": 1, "background-image": "url('/img/background.jpg')", "background-position": "50% 0", "background-size": "contain", "background-repeat": "no-repeat" })) Body
